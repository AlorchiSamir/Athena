<div class="modal fade" id="message-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id='message-pro-form' method="POST" action="<?php echo e(url('request/send')); ?>" enctype="multipart/form-data">
...
</div> <?php /**PATH C:\wamp\www\athena\resources\views/requests/modal.blade.php ENDPATH**/ ?>