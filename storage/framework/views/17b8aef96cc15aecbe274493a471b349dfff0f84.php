                ...
                <div class="card-body">
                    ...
                    <div class='buylink'>
                        <?php if(count($book->buyLinks) > 0): ?>
                            <div class='col-md-4  offset-md-2 link' style='background-image: url(<?php echo e(url("graphics/amazon.png")); ?>)' ><a href="<?php echo e($book->buyLinks[0]->link); ?>"><?php echo e($book->buyLinks[0]->link); ?></a></div>
                        <?php else: ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\athena\resources\views/admin/books/view.blade.php ENDPATH**/ ?>