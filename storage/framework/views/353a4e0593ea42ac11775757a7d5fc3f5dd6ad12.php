    ...
    <div class="row">
        <div class="col-md-5 offset-md-1">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(url('admin/book/insert')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="datepicker" type="text" class="form-control" name="release_date" value="<?php echo e(old('release_date')); ?>">                                
                            </div>
                        </div>                   
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\athena\resources\views/admin/books/create.blade.php ENDPATH**/ ?>