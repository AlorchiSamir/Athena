		...
		<div class="span12">
			<div class="tableau">
				...
				<div class="tableau-body">
					<div class="clearfix">
						<div class="btn-group">
							<a href="{{ url('admin/tag/create') }}" id="create" class="btn green">Ajouter</a>
						</div>
					</div>
					<table class="table table-striped table-bordered table-hover table-full-width" id="category_table">
						...
						<tbody><?php
							foreach ($tags as $tag){ 
								...
								<td><a href="{{ url('admin/tag/update/'.$tag->id) }}" class='btn btn-primary'><i class='icon-edit'></i> Modifier</a></td></tr>
							<?php }
						?></tbody>
					</table>					
				</div>				
