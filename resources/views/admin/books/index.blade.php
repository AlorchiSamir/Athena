		...
		<div class="span12">
			<div class="tableau">
				...
				<div class="tableau-body">
					<div class="clearfix">
						<div class="btn-group">
							<a href="{{ url('admin/book/create') }}" id="create" class="btn green">Ajouter</a>
						</div>
					</div>
					<table class="table table-striped table-bordered table-hover table-full-width" id="book_table">
						...
						<tbody><?php
							foreach ($books as $book){ 
								?>
								<tr onclick="location.href='{{ url('admin/book/'.$book->id) }}'">
									...
									<td><a href="{{ url('admin/book/update/'.$book->id) }}" class='btn btn-primary'><i class='icon-edit'></i> Modifier</a></td>
								</tr>
							<?php }
						?></tbody>
					</table>					
