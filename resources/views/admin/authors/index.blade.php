		...
		<div class="span12">
			<div class="tableau">
				...
				<div class="tableau-body">
					<div class="clearfix">
						<div class="btn-group">
							<a href="{{ url('admin/author/create') }}" id="create" class="btn green">Ajouter</a>
						</div>
					</div>
						...
						<tbody><?php
							foreach ($authors as $author){ 
								...
								<tr>
									...
									<td><a href="{{ url('admin/author/update/'.$author->id) }}" class='btn btn-primary'><i class='icon-edit'></i> Modifier</a></td>
								</tr>
							<?php }
						?></tbody>
					</table>					
